...
package com.medicineapp.exception;
/**
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler  {
	...
	protected ResponseEntity<Object> handleHospitalNotFound(MedicineNotFoundException ex) {
		String message = ex.getMessage();
		LocalDateTime timestamp = LocalDateTime.now();
		String error = "medicine not available";
