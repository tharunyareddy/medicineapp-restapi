...
public interface IBrandRepository extends JpaRepository<Brand, Integer> {
	...
	@Query("from Brand b inner join b.medicineList m  where b.brandName=?1 and m.medicineName=?2")
	List<Brand> findByBrandNameAndMedicineName(String brandName, String medicineName);
