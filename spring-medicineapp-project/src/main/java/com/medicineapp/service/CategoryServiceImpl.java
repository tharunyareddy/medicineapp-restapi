...
public class CategoryServiceImpl implements ICategoryService {
	...
	@Override
	public List<Category> getByCategoryNameAndMedicineName(String categoryName, String medicineName)
			throws MedicineNotFoundException {
		List<Category> categoryByNameAndMedicineName = categoryRepository.findByCategoryNameAndName(categoryName,
				medicineName);
