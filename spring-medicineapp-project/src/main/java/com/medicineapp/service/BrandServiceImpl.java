...
public class BrandServiceImpl implements IBrandService {
	...
	@Override
	public List<Brand> getByBrandNameAndMedicineName(String brandName, String medicineName)
			throws MedicineNotFoundException {

		List<Brand> medicineByBrandNameAndName = brandRepository.findByBrandNameAndMedicineName(brandName,
				medicineName);
